export const sdkCardInfo =
{
  "React": {
    ...
    "links": [
      ...
      {
        "label": "Reference",
        "url": "https://docs-staging-feat-sdk-reference-docs.mintlify.site/docs/sdk/auth0-react/functions/Auth0Provider"
      }
    ]
  },
  "Vue": {
    ...
    "links": [
      ...
      {
        "label": "Reference",
        "url": "/docs/sdk/typescript/classes/Auth0Client"
      }
    ]
  },
  "Angular": {
