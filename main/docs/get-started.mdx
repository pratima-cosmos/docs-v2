...
<Card title="Backend/API" icon="/docs/images/icons/light/dotnet-platform.svg" href="/docs/quickstart/backend">
An API or service protected by Auth0, like Express.js API or ASP.NET API.
</Card>

<Card title="AI Agent" icon="/docs/images/icons/light/ai-agent.svg" href="https://auth0.com/ai/docs">
...
<Card title="Applications in Auth0" icon="/docs/images/icons/light/applications.svg" href="/docs/get-started/applications">
...
<Card title="Manage Dashboard Access" icon="/docs/images/icons/light/manage-access.svg" href="/docs/get-started/manage-dashboard-access">
